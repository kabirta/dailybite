...
const bn: Record<string, string> = {
  ...
  Cals: "ক্যালরি",
  "Foods Eaten": "খাওয়া খাবার",
  Foods: "খাবার",
  Times: "বার",
  Eaten: "খাওয়া",
  "Snacks/Other": "স্ন্যাকস/অন্যান্য",
  "Daily Avg": "দৈনিক গড়",
  "Goal Progress": "লক্ষ্যের অগ্রগতি",
  Macronutrients: "ম্যাক্রোনিউট্রিয়েন্ট",
  Carbohydrate: "কার্বোহাইড্রেট",
  Prot: "প্রোটিন",
  Nutrients: "পুষ্টি",
  Nutrient: "পুষ্টি উপাদান",
  "Calories (kcal)": "ক্যালরি (kcal)",
  "Protein (g)": "প্রোটিন (g)",
  "Carbohydrate (g)": "কার্বোহাইড্রেট (g)",
  "Fiber (g)": "ফাইবার (g)",
  "Sugar (g)": "চিনি (g)",
  "Fat (g)": "ফ্যাট (g)",
  "Cholesterol (mg)": "কোলেস্টেরল (mg)",
  "Sodium (mg)": "সোডিয়াম (mg)",
  "Potassium (mg)": "পটাশিয়াম (mg)",
  "Water (ml)": "পানি (ml)",
  "Sleep (min)": "ঘুম (মিনিট)",
  "Exercise (min)": "ব্যায়াম (মিনিট)",
};
